...
<section id="capabilities"><div class="wrap"><p class="section-label">What it does</p><h2>Four things. One wall with a gate.</h2><div class="cap-grid"><div class="cap"><h3><span class="stamp stamp-allowed">ALLOWED</span> Allowlist</h3><p>Name the tools, domains, and endpoints each agent may touch. Everything else denied by default.</p></div><div class="cap"><h3><span class="stamp stamp-denied">DENIED</span> Redaction</h3><p>Secrets and personal data stripped from outbound calls before they leave your network.</p></div><div class="cap"><h3><span class="stamp stamp-held">HELD</span> Risk gate</h3><p>Destructive actions — deletes, spend, sends — held for human approval.</p></div><div class="cap"><h3><span class="stamp stamp-allowed">ALLOWED</span> Signed audit log</h3><p>Every call, allowed or denied, becomes a signed, immutable record — compliance evidence, not a log file.</p></div></div></div></section>
